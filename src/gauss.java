...
/* PROSES MENGUBAH MATRIKS KE BENTUK nCols-1 = nRows */
        ...
        if((mainmatrix0.nCols-1) > mainmatrix0.nRows){
            ...
            System.out.println("mainmatrix  kasus 1:");
            mainmatrix.displayMatrix();
        }else{
            ...
            if(countBar0 <=1){
                ...
                if(det ==0){
                    ...
                    if(lastIdx !=0){
                        ...
                        // Matriks M = new Matriks(mainmatrix.nCols-1, mainmatrix.nCols);
                        // M.copyMatrix(mainmatrix);
                            ...
                            if ((mainmatrix.nRows-1-countBar0)<i){ 
                                ...
                                for(int kolstr =0 ; kolstr < matrixString.nCols;kolstr++){
                                    ...
                                    for(j=mainmatrix.nCols-2;j>i;j--){
                                        // System.out.print("Matriks M  Cols: ");
                                        // mainmatrix.displayMatrix(); // matriks yang awal 
                                        // j = 5,4,3,2,1,0
                                        // j = 5 dia looping buat memperbaiki nilai dari pengurangSol 
                                        pengurangStr += mainmatrix.mat[i][j]*matrixString.mat[j][kolstr];
                                    }
                                    // System.out.print("Pengurang str : ");
                                    // System.out.println(pengurangStr);
                                ...
                                System.out.println(matrixNum.mat[i][0]);
                                System.out.print("Pengurang str : ");
                                System.out.println(pengurangStr);
                                System.out.print("pengurang Num");
                                System.out.println(pengurangNum);
                                pengurangNum =0;
                            }
                            pengurangStr = 0;
                    ...
                    if ((mainmatrix.nRows-1-countBar0)<i){ 
                        ...
                        for(int kolstr =0 ; kolstr < matrixString.nCols;kolstr++){
                            ...
                            for(j=mainmatrix.nCols-2;j>i;j--){
                                ...
                                pengurangStr += mainmatrix.mat[i][j]*matrixString.mat[j][kolstr];
                                // System.out.println(pengurangStr += mainmatrix.mat[i][j]*matrixString.mat[j][kolstr]);
